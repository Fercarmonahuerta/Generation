...
//Aquí se guardarán las temperaturas 
...
console.log(`El resultado de sumar los números del 1 al 10 es: ` + suma);
...
let numeroIngresado = prompt("Ingrese un número para verificar si es primo:");
...
function esPrimo(numero) {
  ...
  // Verificar si el número es divisible por algún número desde 2 hasta la raíz cuadrada de 'numero'
...
} else if (esPrimo(numeroIngresado)) {
...
function generarFibonacci(n) {
  ...
  let primeros10Terminos = generarFibonacci(10);
  
 
  console.log("Los primeros 10 términos de la secuencia de Fibonacci son:");
  console.log(primeros10Terminos.join(", "));
